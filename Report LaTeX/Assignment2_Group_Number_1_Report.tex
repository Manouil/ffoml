...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.8\textwidth]{./plots/screenshot6.png}  % Automatically scales to page width
    \caption{Application of the left sobel matrix highlights vertical high to low transitions of the face image (Powell)}
    \label{fig:plot12}  % Label for referencing the figure
\end{figure}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[t]{\textwidth}
        \centering
        \includegraphics[width=0.7\textwidth]{./plots/screenshot10.png} % Replace with your second image file
    ...
    \begin{subfigure}[t]{\textwidth}
        \centering
        \includegraphics[width=0.3\textwidth]{./plots/screenshot11.png} % Replace with your second image file
        \caption{Legand.}
        \label{fig:subfig17b}
    \end{subfigure}
...
\begin{figure}[h!]
    ...
    \begin{subfigure}[t]{0.3\textwidth} % Adjust width as needed
        \centering
        \includegraphics[width=\textwidth]{./plots/plot13.png} % Replace with your first image file
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{./plots/plot14.png} % Replace with your second image file
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{./plots/plot15.png} % Replace with your third image file
